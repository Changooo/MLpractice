...
class simpleMLP:
    def __init__(self, input_size, output_size):
        ...
        self.W = torch.FloatTensor(np.zeros((input_size, output_size)))
        self.b = torch.FloatTensor(np.zeros((output_size)))
...
class simpleRNN:
    def __init__(self, input_size, hidden_size):
        ...
        self.Wh = torch.FloatTensor(np.zeros((hidden_size, hidden_size)))
        self.bh = torch.FloatTensor(np.zeros((hidden_size)))
        self.status = None
        self.output = None
        self.tanh = nn.Tanh()
